...
interface ClaudeHookEntry { type: string; command: string }
interface ClaudeHookMatcher { matcher?: string; hooks: ClaudeHookEntry[] }
...
const pluginSrc = resolve(import.meta.dir, "..", "packages", "hook-opencode")
