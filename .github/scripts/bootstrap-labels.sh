...
label "priority: high"     "e11d48" "High priority"
label "priority: medium"   "fbca04" "Medium priority"
label "priority: low"      "0e8a16" "Low priority"

echo ""
echo "==> Package labels"
label "package: types"            "bfd4f2" ""
label "package: core"             "bfd4f2" ""
label "package: cli"              "bfd4f2" ""
label "package: hook-claude-code" "bfd4f2" ""
label "package: plugin-opencode"  "bfd4f2" ""
